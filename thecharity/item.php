...
<div class="col-12"><div class="top-header-bar">
            <div class="container">
			
<center>
  <font color="black"> <h1>Donation Item</h1>    </div></font>
			</div>                      
</br><center>
</br>
<?php
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
		echo '<div style="align:center; box-shadow: 10px 10px 5px #888888; padding-left:10px;border:1px; border-radius:5px;background-color:#ff4800"><form action="procure.php" method="post">';
        echo "<br><b>Item Name :- </b>" . $row["itemname"]."<br> <b>Type :- </b>" . $row["types"]. "<br> <b>Description :- </b> " . $row["description"]."<br><b> Pick up start Date: </b>" . $row["starttime"]."<br><b> Pick up end Date: </b>" . $row["endtime"]."<br><b> Pick up Estimate Timing:</b> ". $row["time"]. "<br><b> Address: </b>" . $row["address"]."<br><b> Pincode :- </b>" . $row["pincode"]."<br><b></b>" ;
		echo '<input type="hidden" name="item" value='.$row["itemname"].'><input type="hidden" name="type" value='.$row["types"].'>';
		echo '<br><input type="submit" value="procure" ><br><br></form></div><br><br>';  
