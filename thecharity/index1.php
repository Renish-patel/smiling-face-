                    ...
                    <div class="col-12 d-flex flex-wrap justify-content-between align-items-center">
                        ...
                        <nav class="site-navigation d-flex justify-content-end align-items-center">
                            <ul class="d-flex flex-column flex-lg-row justify-content-lg-end align-content-center">
                                ...
                                <li><?php echo $session_fullName; ?>
								<div>
								
								
								</div><li><a href="logout.php">Logout</a></li>
                        ...
                        <div class="row h-100">
                            <div class="col-12 col-lg-8 d-flex flex-column justify-content-center align-items-start">
                                ...
                                <div class="entry-content mt-4">
                                   <p>35 million people in the India are hungry or don’t know where their next meal is coming from, and 13 million of them are children. Do not you want to help them? If you want to help them, please donate
  
                                </div><!-- .entry-content -->

                                <footer class="entry-footer d-flex flex-wrap align-items-center mt-5">
                                    <a href="donate.php" class="btn orange-border">Donate Now</a> &nbsp; &nbsp;
                                    <a href="item.php" class="btn orange-border">Procure Now</a>
                                </footer><!-- .entry-footer -->
                            </div><!-- .col -->
                        </div><!-- .row -->
                    </div><!-- .container -->
                    ...
                    <div class="container h-100">
                        <div class="row h-100">
                            <div class="col-12 col-lg-8 d-flex flex-column justify-content-center align-items-start">
                                ...
                                <div class="entry-content mt-4">
                                    <p>We know that a peaceful world cannot long exist, one-third rich and two-thirds hungry</p>
                                </div><!-- .entry-content -->

                                <footer class="entry-footer d-flex flex-wrap align-items-center mt-5">
                                    <a href="Donate1.php" class="btn orange-border">Donate Now</a> &nbsp; &nbsp;
                                    <a href="#" class="btn orange-border">Procure Now</a>
                                </footer><!-- .entry-footer -->
                            </div><!-- .col -->
                        </div><!-- .row -->
                    </div><!-- .container -->
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6 col-lg-4 mt-4 mt-lg-0">
                    <div class="icon-box active">
                        ...
                        <header class="entry-header">
                            <h3 class="entry-title">NGOs</h3>
                        </header>

                        <div class="entry-content">
                            <p>“We support about 5,000 non-governmental organizations (NGOs) with software, training, and technical support. We provide our software at virtually no cost to them, and they're lighting up the world with what they do.”</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-12 col-lg-6 order-2 order-lg-1">
                    <div class="welcome-content">
                        ...
                        <div class="entry-content mt-4">
                            <p>Most people don't realize how much food they throw away every day — from uneaten leftovers to spoiled produce. About 95 percent of the food we throw away ends up in landfills or combustion facilities. In 2013, we disposed more than 35 million tons of food waste. Many people wish to donate things to needy organizations. Also, many organizations wish to ask for various things required by them such as clothes, food grains, books, utensils, etc., but there is no source available through which they can satisfy their requirements. Thereby, an it's Easy to HELP website has been developed through which people can donate items as per their capacity and the website also allows organizations to put up their requests, i.e. items required by them, if any. The majority of the population today uses smartphones with active internet connection, which is the basic requirement for this product to function properly "</p>
                        </div><!-- .entry-content -->
                ...
                <div class="col-19 col-lg-6 mt-5 order-1 order-lg-2">
                   &nbsp;&nbsp;&nbsp;&nbsp; <img src="images/Wc Charity.jpg " widget="100" alt="welcome"> 
                </div><!-- .col -->
            </div><!-- .row -->
        </div><!-- .container -->
    </div><!-- .home-page-icon-boxes -->
