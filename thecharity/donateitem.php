...
<body>
  ...
  <center> <font color="black"><h1 align="left">Your Donatation List </h1></center>  </font>     
...
<table>
<table class="a11"  >
<tr class="top-header-bar" >
<th  class="a2" > Item Name </th> 
<th class="a2" > User name </th>
<th class="a2"  > Types  </th>
<th class="a2"  >E-mail</th>
<th class="a2" >Contact</th>
...
$sql = "SELECT username,types,email,contect,donate FROM item";
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
		echo '<tr>';
        echo "<td>" . $row["donate"]."</td><td>"  . $row["username"]."</td><td>" . $row["types"]."</td><td>" . $row["email"]."</td><td>" . $row["contect"]."</td><td>";
echo '</tr>';  
